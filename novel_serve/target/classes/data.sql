...
-- 豆包模型（通义千问，有免费额度）
INSERT INTO ai_models (name, provider, model_type, api_url, model_id, max_tokens, temperature, is_active, created_at, updated_at) VALUES
('豆包 Pro-128K', 'qwen', 'chat', 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions', 'qwen-max-latest', 8000, 0.7, true, NOW(), NOW()),
('豆包 Plus', 'qwen', 'chat', 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions', 'qwen-plus', 8000, 0.7, true, NOW(), NOW()),
('豆包 Turbo', 'qwen', 'chat', 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions', 'qwen-turbo', 8000, 0.7, true, NOW(), NOW());
